SRCPATH=../../x264
prefix=/Volumes/NETAC/work/CodeSample/X264/thin-x264/arm64
exec_prefix=${prefix}
...
STRIP=strip
INSTALL=install
AS=/Volumes/NETAC/work/CodeSample/X264/x264/tools/gas-preprocessor.pl -arch aarch64 -- xcrun -sdk iphoneos clang
